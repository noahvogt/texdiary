...
%    
%           }
%]{}{SlideShow.swf}\pgfuseimage{../logo/version2.png
           \movie[externalviewer, autostart]{\includegraphics[height=0.8\textheight]{../logo/version3b.png}}{media/appNoSound.mp4}
\end{frame}
